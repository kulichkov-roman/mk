 ...
 */
class CreateRestaurantIBlockMigration extends AbstractIBlockMigration
{
	/**
	 * {@inheritdoc}
	 */
	public function up()
	{
		...
		try {
			...
			$logger->log(
				sprintf('IBlock has been created. Id: "%s". Add to "restaurantIBlockId"', $this->iblockId)
			);
	...
	public function down()
	{
		...
		$this->deleteIBlock($environment->get('restaurantIBlockId'));

		$logger->log(sprintf('IBlock restaurantIBlockId has been removed. Id: "%s"', $this->iblockId));
	}
}

$migration = new CreateRestaurantIBlockMigration();
$migration->up();
