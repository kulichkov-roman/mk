 ...
 */
class CreateAboutIBlockMigration extends AbstractIBlockMigration
{
	/**
	 * {@inheritdoc}
	 */
	public function up()
	{
		...
		try {
			...
			$logger->log(
				sprintf('IBlock has been created. Id: "%s". Add to "aboutIBlockId"', $this->iblockId)
			);
	...
	public function down()
	{
		...
		$this->deleteIBlock($environment->get('aboutIBlockId'));

		$logger->log(sprintf('IBlock aboutIBlockId has been removed. Id: "%s"', $this->iblockId));
	}
}

$migration = new CreateAboutIBlockMigration();
$migration->up();
