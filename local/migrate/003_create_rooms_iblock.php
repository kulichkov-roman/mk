 ...
 */
class CreateRoomsIBlockMigration extends AbstractIBlockMigration
{
	/**
	 * {@inheritdoc}
	 */
	public function up()
	{
		...
		try {
			...
			$logger->log(
				sprintf('IBlock has been created. Id: "%s". Add to "roomsIBlockId"', $this->iblockId)
			);
	...
	public function down()
	{
		...
		$this->deleteIBlock($environment->get('roomsIBlockId'));

		$logger->log(sprintf('IBlock roomsIBlockId has been removed. Id: "%s"', $this->iblockId));
	}
}

$migration = new CreateRoomsIBlockMigration();
$migration->up();
